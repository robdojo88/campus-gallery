    ...
    return (
                        ...
                        {aliasRequired ? (
                            <div className='mb-3 rounded-2xl border border-amber-200 bg-amber-50 p-3'>
                                ...
                                <p className='mt-1 text-xs text-amber-800'>
                                    This is required before posting. Once saved,
                                    it is locked and only admin/developer can
                                    change it.
                                </p>
       ...
       focus:outline-none focus:ring-0',
                            ...
                            <Button
                                onClick={() => void submit()}
                                isDisabled={
                                    posting || aliasRequired || profileLoading
                                }
                                color='primary'
